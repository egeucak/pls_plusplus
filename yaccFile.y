...
%token BLTIN_HACK BLTIN_DISCONNECT BLTIN_CHECK BLTIN_SYNC BLTIN_DOWNL BLTIN_UPL
...
%left MULTIPLY_OPT DIVIDE_OPT POW_OPT MODE_OPT
%%
program: function 
		| program function 
		;
...
function_call: BLTIN_PRINT LEFT_PARANTHESIS identifier_list RIGHT_PARANTHESIS
		| BLTIN_OPEN LEFT_PARANTHESIS STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_WRITE LEFT_PARANTHESIS IDNTF COMMA STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_DEL LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_COMPARE LEFT_PARANTHESIS IDNTF COMMA IDNTF RIGHT_PARANTHESIS
		| BLTIN_LISTCONT LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_SORTD LEFT_PARANTHESIS IDNTF COMMA STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_GETSIZE LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_GETTYPE LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_CLOSE  LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_HACK LEFT_PARANTHESIS STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_CONNECT LEFT_PARANTHESIS STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_DISCONNECT LEFT_PARANTHESIS IDNTF RIGHT_PARANTHESIS
		| BLTIN_CHECK LEFT_PARANTHESIS IDNTF str_or_void RIGHT_PARANTHESIS
		| BLTIN_SYNC LEFT_PARANTHESIS IDNTF str_or_void RIGHT_PARANTHESIS
		| BLTIN_DOWNL LEFT_PARANTHESIS IDNTF COMMA STR_LTRL RIGHT_PARANTHESIS
		| BLTIN_UPL LEFT_PARANTHESIS IDNTF COMMA STR_LTRL RIGHT_PARANTHESIS
		;
